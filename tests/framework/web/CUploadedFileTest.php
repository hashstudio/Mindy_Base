<?php
use Mindy\Base\UploadedFile;

/**
 * Unit test for "system.web.UploadedFile".
 * @see UploadedFile
 */
class CUploadedFileTest extends CTestCase
{
    ...
    public function testGetInstanceByName()
    {
        ...
        $uploadedFile = UploadedFile::getInstanceByName($inputName);
    ...
    public function testGetInstancesByName()
    {
        ...
        $uploadedFiles = UploadedFile::getInstancesByName($inputName);
    ...
    public function testGetInstanceByNestedName()
    {
        ...
        $uploadedFile = UploadedFile::getInstanceByName("{$baseInputName}[{$subInputName}]");
    ...
    public function testGetInstancesByNamePartOfOtherName()
    {
        ...
        $uploadedFiles = UploadedFile::getInstancesByName($baseInputName);
