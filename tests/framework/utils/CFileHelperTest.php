...
class CFileHelperTest extends CTestCase
{
    ...
    {
        $this->testDir = Alias::get('application.runtime.CFileHelper');
    ...
    public function testGetMimeTypeByExtension()
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            $this->assertNull(FileHelper::getMimeTypeByExtension('test.txa'));
            $this->assertNull(FileHelper::getMimeTypeByExtension('test.txb'));
            $this->assertEquals('text/plain', FileHelper::getMimeTypeByExtension('test.txt'));

            $this->assertEquals('application/json', FileHelper::getMimeTypeByExtension('test.txa', $this->testDir . 'mimeTypes1.php'));
            $this->assertEquals('another/mime', FileHelper::getMimeTypeByExtension('test.txb', $this->testDir . 'mimeTypes1.php'));
            $this->assertNull(FileHelper::getMimeTypeByExtension('test.txt', $this->testDir . 'mimeTypes1.php'));

            $this->assertNull(FileHelper::getMimeTypeByExtension('test.txa', $this->testDir . 'mimeTypes2.php'));
            $this->assertEquals('another/mime2', FileHelper::getMimeTypeByExtension('test.txb', $this->testDir . 'mimeTypes2.php'));
            $this->assertEquals('text/plain', FileHelper::getMimeTypeByExtension('test.txt', $this->testDir . 'mimeTypes2.php'));
        }
    }
    ...
    public function testCopyDirectory_subDir_modeShoudBe0775()
    {
        ...
        FileHelper::copyDirectory($src, $dst, array('newDirMode' => $this->testMode));
    ...
    public function testRemoveDirectory()
    {
        ...
        FileHelper::removeDirectory($bd . $this->rootDir2);
    ...
    public function testFindFiles_absolutePaths()
    {
        ...
        $files = FileHelper::findFiles($this->testDir);
    ...
    public function testFindFiles_relativePaths()
    {
        ...
        $files = FileHelper::findFiles($this->testDir, array('absolutePaths' => 0));
    ...
    public function testCreateDirectory()
    {
        ...
        $this->assertTrue(FileHelper::createDirectory($path, null, true));
